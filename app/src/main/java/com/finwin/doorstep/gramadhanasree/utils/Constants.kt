package com.finwin.doorstep.gramadhanasree.utils
...
class Constants {
    companion object{
        ...
        const val TRANSACTION_TIME: String="TRANSACTION_TIME"
        const val LOAN_ACCOUNT_NUMBER: String="LOAN_ACCOUNT_NUMBER"
        const val LOAN_CUSTOMER_NAME: String="LOAN_CUSTOMER_NAME"
        const val REMITTANCE_AMOUNT: String="REMITTANCE_AMOUNT"
        ...
        var INTENT_SEARCH_ACCOUNT_FROM_JLG_SPLIT:Int =17
        var INTENT_FROM_LOAN_COLLECTION:Int =18
    }
}