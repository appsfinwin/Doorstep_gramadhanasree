package com.finwin.doorstep.gramadhanasree.home.jlg.jlg_split_closing
...
class SplitClosingViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var sharedPreferences: SharedPreferences = application.getSharedPreferences(com.finwin.doorstep.gramadhanasree.utils.Constants.PREFERENCE_NAME,
...
//    var branchCode = ObservableField("")
    ...
    var repository = SplitClosingRepository().getInstance()
    ...
    fun splitTransaction() {
        ...
        val jsonParams: MutableMap<String?, Any?> = HashMap()
        jsonParams["Ln_Type"] = ""
        jsonParams["Brcode"] = sharedPreferences.getString(com.finwin.doorstep.gramadhanasree.utils.Constants.BRANCH_ID,"")
        jsonParams["Tran_no"] = ""
        ...
        jsonParams["MakerId"] = sharedPreferences.getString(com.finwin.doorstep.gramadhanasree.utils.Constants.AGENT_ID,"")
